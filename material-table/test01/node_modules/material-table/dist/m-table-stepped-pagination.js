  ...
  (0, _createClass2["default"])(MTablePaginationInner, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        variant: page === 0 ? 'h6' : 'body1'
      }, "1"))), page > 2 && React.createElement("span", null, ".."), page > 1 && React.createElement("span", null, React.createElement(_core.IconButton, {
        onClick: this.handleNumberButtonClick(page - 1),
        "aria-label": localization.lastAriaLabel
      }, React.createElement(_core.Typography, {
        variant: "body1"
      }, page))), page > 0 && page < maxPages && React.createElement("span", null, " ", React.createElement(_core.IconButton, {
        onClick: this.handleNumberButtonClick(page),
        "aria-label": localization.lastAriaLabel
      }, React.createElement(_core.Typography, {
        variant: "h6"
      }, page + 1))), page < maxPages - 1 && React.createElement("span", null, React.createElement(_core.IconButton, {
        onClick: this.handleNumberButtonClick(page + 1),
        "aria-label": localization.lastAriaLabel
      }, React.createElement(_core.Typography, {
        variant: "body1"
      }, page + 2))), page < maxPages - 2 && React.createElement("span", null, ".."), maxPages > 0 && React.createElement("span", null, " ", React.createElement(_core.IconButton, {
        onClick: this.handleLastPageButtonClick,
        "aria-label": localization.lastAriaLabel
      }, React.createElement(_core.Typography, {
        variant: page === maxPages ? 'h6' : 'body1'
      }, maxPages + 1)))), React.createElement(_core.Tooltip, {
